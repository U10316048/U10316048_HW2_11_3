...
public class TestAccount {
	...
	public static void main(String[] args){
		...
		Account object = new Account(a,b,c); //Create a account with id = 1122,balance = 20000,c = 4.5%
		
		if(a==1122){ //judge whether the id is 1122
			System.out.println(object.toString());//Display the balance and annual interest rate
			...
			while(true){ //Decide the action that the user want to do 
				if(ans.equals("d")){
